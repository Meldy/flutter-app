...
import 'package:smart_city_traveller/Home_page/the_main.dart';
...
class AuthTypeSelector extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Smart city traveller'),
      ),
      body: Column(
        ...
        children: <Widget>[
          ...
          Container(
            ...
            child: SignInButtonBuilder(
              ...
              text: 'Sign In',
              //onPressed: () => _pushPage(context, SignInPage()), redirects to the signin page which is being worked on
              onPressed: () => _pushPage(context, const MyMap()),
            ),
          ),
        ],
      ),
